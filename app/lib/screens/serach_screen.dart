...
class _SerachScreen extends State<SearchScreen> {
  ...
  Future<void> _refreshPosts2(BuildContext context, String boardId,
      TextEditingController editingController) async {
    await Provider.of<Posts>(context, listen: false)
        .fetchAndSetPosts2(boardId, editingController.value.text);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () =>
              {_refreshPosts(context, args.toString()), Navigator.pop(context)},
