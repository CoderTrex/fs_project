...
class Comments with ChangeNotifier {
  ...
  Future<void> fetchAndSetComments(String postId) async {
    ...
    var url = Uri.parse(
        'https://chatting-test-863cb-default-rtdb.asia-southeast1.firebasedatabase.app/comments.json?auth=$authToken');
    try {
  ...
  Future<void> deleteComment(String id) async {
    final url = Uri.parse(
        'https://chatting-test-863cb-default-rtdb.asia-southeast1.firebasedatabase.app/comments/$id.json?auth=$authToken');
