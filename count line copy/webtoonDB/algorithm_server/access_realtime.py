...
class Firebase_User_Base_INFO:
    ...
    def create_user_base_recommendations(self):
        ...
        print(user_subscrible_list)
            ...
            # thumbnail = content['thumnail']  # Note the typo in the original data, 'thumnail' instead of 'thumbnail'
        ...
        # _____________________  비상 api가 접근을 막음 ______________________ #
...
user = Firebase_User_Base_INFO('uid11234')
